<div id="nav" style="margin-bottom:100px;">
	<form id="form3" name="form3" method="post" action="">
		<ul class="navbar">
			...
			<li class="nav-info" style="padding: 0.5em 1em;">ชื่อเล่น: <?php echo $row_Recordset1['name']; ?></li>
			<li class="nav-info" style="padding: 0.5em 1em;">แต้ม: <?php echo $row_Recordset1['point']; ?></li>
